class __base(UActorComponent, 0) UDBDPlayerData
{
/*0x0000*/  struct UDBDPlayerData::VTable* vtable;
...
/*0x00e8*/  bool Blinded;
/*0x00e9*/  bool _interactionInputPressed;
/*0x00ea*/  bool _useItemInputPressed;
/*0x00eb*/  bool _fastInteractionInputPressed;
/*0x00ec*/  bool _interactionInputMashed;
/*0x00ed*/  bool _leftRightInputMashed;
/*0x00ee*/  bool _attackInputPressed;
/*0x00ef*/  bool _useInputPressed;
/*0x00f0*/  bool _actionInputPressed;
/*0x00f1*/  bool _gameLevelLoaded;
/*0x00f2*/  bool _lightSpawned;
/*0x00f3*/  bool _loadoutSpawned;
/*0x00f4*/  bool _introCompleted;
            __padding char _f5[3];
/*0x00f8*/  struct FYawAndPitchRotator_NetQuantize32 _controlRotation;
/*0x0104*/  bool _autoLeftRightMash;
/*0x0105*/  bool _autoInteractionMash;
};
