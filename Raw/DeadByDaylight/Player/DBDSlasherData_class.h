class __base(UDBDPlayerData, 0) UDBDSlasherData
{
/*0x0000*/  struct UDBDSlasherData::VTable* vtable;
...
/*0x0108*/  uint8_t VisionEnabled;
/*0x0109*/  uint8_t CloakingEnabled;
/*0x010a*/  enum ESlasherGuidedAction CurrentGuidedAction;
/*0x010c*/  float SoundDisplayLifetime;
};
