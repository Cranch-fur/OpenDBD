class __base(UActorComponent, 0) UDBDDebugInputComponent
{
/*0x0000*/  struct UDBDDebugInputComponent::VTable* vtable;
...
/*0x00e8*/  uint8_t ItsAlive;
/*0x00ec*/  float _timeAggregator;
/*0x00f0*/  float _timeAggregatorAlt;
/*0x00f4*/  float _currentTime;
};
