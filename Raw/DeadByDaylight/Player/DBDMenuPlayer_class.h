class __base(ACharacter, 0) ADBDMenuPlayer
{
/*0x0000*/  struct ADBDMenuPlayer::VTable* vtable;
...
/*0x07a0*/  class TMulticastDelegate<void> OnDestroyedNonDynamic;
/*0x0810*/  bool RoleSelected;
/*0x0811*/  bool IsOnline;
/*0x0814*/  int32_t CharacterIndex;
/*0x0818*/  enum EItemHandPosition _handPosition;
/*0x0820*/  class USkeletalMeshComponent* ItemMesh;
/*0x0828*/  class FName _equippedItemName;
};
