class __base(UActorComponent, 0) UActorClipperComponent
{
/*0x0000*/  struct UActorClipperComponent::VTable* vtable;
...
/*0x00e8*/  class UShapeComponent* Shape;
/*0x00f0*/  class TArray<FName, FDefaultAllocator> _tags;
/*0x0100*/  class TMap<AActor*, FClippedActor, FDefaultSetAllocator, TDefaultMapKeyFuncs<AActor*, FClippedActor, 0>> _clippedActors;
/*0x0150*/  bool _registeredToShapOverlap;
/*0x0151*/  bool _clippingEnabled;
};
