class __base(ADBDPlayerControllerBase, 0) ADBDPlayerController
{
/*0x0000*/  struct ADBDPlayerController::VTable* vtable;
...
/*0x08c4*/  __inherited bool ADBDPlayerControllerBase::_uploadStatsNeeded;
            __padding char _8c5[3];
/*0x08c8*/  class FOnPawnLeavingGameDelegate OnPawnLeavingGame;
/*0x08d8*/  class FOnLocallyObservedChangedDelegate OnLocallyObservedChanged;
            __padding char _8e8[8];
/*0x08f0*/  class TMulticastDelegate<void, ADBDPlayer*> OnPawnLeavingGameRaw;
/*0x0960*/  bool _hasMoveInputThisFrame;
/*0x0961*/  bool _didSetLocalPawn;
/*0x0968*/  class ANetworkFenceActor* _theFence;
/*0x0970*/  bool _spectating;
            __padding char _971[3];
/*0x0974*/  struct FDBDTimer _yawInputScalingTimer;
/*0x0994*/  struct FDBDTimer _pitchInputScalingTimer;
/*0x09b4*/  float _targetYawInputScaling;
/*0x09b8*/  bool _resettingYawScaling;
/*0x09bc*/  float _targetPitchInputScaling;
/*0x09c0*/  bool _resettingPitchScaling;
/*0x09c4*/  float _constantYawScale;
/*0x09c8*/  float _absoluteYawScale;
/*0x09cc*/  float _previousConstantYawScale;
/*0x09d0*/  float _previousAbsoluteYawScale;
/*0x09d4*/  float _originalConstantYawScale;
/*0x09d8*/  float _originalAbsoluteYawScale;
/*0x09dc*/  float _constantPitchScale;
/*0x09e0*/  float _absolutePitchScale;
/*0x09e4*/  float _previousConstantPitchScale;
/*0x09e8*/  float _previousAbsolutePitchScale;
/*0x09ec*/  float _originalConstantPitchScale;
/*0x09f0*/  float _originalAbsolutePitchScale;
};
