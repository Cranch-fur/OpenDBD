...
{
    struct ADBDGame_Start::VTable* vtable;
    ...
    __padding char _455[0xb];
    class ADBDGame_Start::FOnDBBInitComplete OnDBDInitComplete;
    enum ELoadProgress _loadProgress;
    enum ELoadCompleteState _loadCompletionState;
    enum EDeferredError _deferredError;
    __padding char _4d3[5];
    struct FTimerHandle _timeoutHandle;
    class FDelegateHandle _generateAuthTicketHandle;
    class FDelegateHandle _initEACHandle;
    class FDelegateHandle _loadProfileHandle;
    class FDelegateHandle _loadStatsHandle;
    class FDelegateHandle _loadCurrenciesHandle;
    __padding char _508[8];
};
