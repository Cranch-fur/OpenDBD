...
{
    struct ADBDGame_Lobby: :VTable* vtable;
    ...
    class FDelegateHandle _onSessionDestroyedHandle;
    float _timerValue;
    uint8_t _forceStarted;
    uint8_t _playerConfigurationReady;
    uint8_t _checkReadyToTravel;
    uint8_t _mustInitgamePresetData;
};
