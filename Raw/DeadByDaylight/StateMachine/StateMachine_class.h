class __base(UActorComponent, 0) __base(IStateCollection, 0xe8) UStateMachine
{
/*0x0000*/  struct UStateMachine::VTable* vtable;
...
/*0x00f0*/  class TArray<TSharedPtr<BaseState, 0>, FDefaultAllocator> _states;
/*0x0100*/  class TSharedPtr<BaseState, 0> _defaultState;
/*0x0110*/  class TArray<TSharedPtr<BaseState, 0>, FDefaultAllocator> _currentStateStack;
/*0x0120*/  class TQueue<TArray<unsigned short, FDefaultAllocator>, 1> _netQueue;
/*0x0130*/  bool _isDrivingStateMachine;
            __padding char _131[7];
/*0x0138*/  class TArray<unsigned short, FDefaultAllocator> _netStateIDStackInitial;
/*0x0148*/  bool _initJoinInProgress;
/*0x0149*/  bool _isRunning;
/*0x014a*/  uint16_t _nextStateID;
/*0x014c*/  bool DebugPrintCurrentStateContinuous;
};
