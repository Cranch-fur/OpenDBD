class __base(APlayerController, 0) ADBDPlayerControllerBase
{
/*0x0000*/  struct ADBDPlayerControllerBase::VTable* vtable;
...
/*0x06b0*/  class UFearMarketManager* FearMarketManager;
            __padding char _6b8[8];
/*0x06c0*/  class TMulticastDelegate<void, bool> OnFearMerketDataRecievedUI;
/*0x0730*/  class TMulticastDelegate<void, bool> OnCloudLoadStatsComplete;
/*0x07a0*/  class TMulticastDelegate<void, bool> OnMirrorCurrenciesLoadComplete;
/*0x0810*/  bool _playerDataRequested;
            __padding char _811[7];
/*0x0818*/  class FDelegateHandle _getTimeHandle;
/*0x0820*/  class FDelegateHandle _statInitHandle;
/*0x0828*/  class FDelegateHandle _statReadHandle;
/*0x0830*/  class FDelegateHandle _statUploadHandle;
/*0x0838*/  class FDelegateHandle _getCurrencyHandle;
/*0x0840*/  class ADBDPlayerControllerBase::FOnKeyPressedEvent _onKeyPressedEvent;
/*0x08b0*/  bool _hasFinishedPlaying;
/*0x08b4*/  float _slasherGamepadScale;
/*0x08b8*/  float _slasherMouseScale;
/*0x08bc*/  float _camperGamepadScale;
/*0x08c0*/  float _camperMouseScale;
/*0x08c4*/  bool _uploadStatsNeeded;
};
