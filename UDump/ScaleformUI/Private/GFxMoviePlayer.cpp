...
void UGFxMoviePlayer::SetViewScaleMode(EGFxScaleMode::Type ScaleMode)
{
...
void UGFxMoviePlayer::SetTimingMode(EGFxTimingMode::Type TimingMode)
{
...
void UGFxMoviePlayer::SetAlignment(EGFxAlign::Type Align)
{
